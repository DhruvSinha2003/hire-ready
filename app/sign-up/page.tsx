      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-12">
        <div className="mx-auto w-full max-w-md space-y-6">
          <div className="space-y-2 text-center">
            <h1 className="text-3xl font-bold text-[#0077B5]">Create an account</h1>
            <p className="text-gray-500">Sign up to get started with HireReady</p>
          </div>
          ...
          <div className="text-center text-sm">
            <p className="text-gray-500">
              ...
              <Link href="/sign-in" className="font-medium text-[#0077B5] hover:text-[#005885]">
                Sign in
              </Link>
            </p>
          </div>
